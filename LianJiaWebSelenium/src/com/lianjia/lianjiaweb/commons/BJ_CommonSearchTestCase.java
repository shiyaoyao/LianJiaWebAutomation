...
public class BJ_CommonSearchTestCase extends AbstractCommonsCategory{
	@Override
	public void testMain() throws Throwable {
		...
		String sug = StringFetch.getString("BJ_ERSHOUFANG_SUG_KEYWORD");
		String keyWord = StringFetch.getString("BJ_ERSHOUFANG_SEARCH_KEYWORD");
		...
		sug = StringFetch.getString("BJ_XINFANG_SUG_KEYWORD");
		keyWord = StringFetch.getString("BJ_XINFANG_SEARCH_KEYWORD"); 
		...
		sug = StringFetch.getString("BJ_XIAOQU_SUG_KEYWORD");
		keyWord = StringFetch.getString("BJ_XIAOQU_SEARCH_KEYWORD"); 
		...
		sug = StringFetch.getString("BJ_FANGJIA_SUG_KEYWORD");
		keyWord = StringFetch.getString("BJ_FANGJIA_SEARCH_KEYWORD"); 
		...
		keyWord = StringFetch.getString("BJ_JINGJIREN_SEARCH_KEYWORD"); 
