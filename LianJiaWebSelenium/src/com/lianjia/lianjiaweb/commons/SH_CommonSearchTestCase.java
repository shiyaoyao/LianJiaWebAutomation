...
public class SH_CommonSearchTestCase extends AbstractCommonsCategory{
	@Override
	public void testMain() throws Throwable {
		...
		String sug = StringFetch.getString("SH_ERSHOUFANG_SUG_KEYWORD");
		String keyWord = StringFetch.getString("SH_ERSHOUFANG_SEARCH_KEYWORD");
		...
		sug = StringFetch.getString("SH_XINFANG_SUG_KEYWORD");
		keyWord = StringFetch.getString("SH_XINFANG_SEARCH_KEYWORD"); 
		...
		sug = StringFetch.getString("SH_XIAOQU_SUG_KEYWORD");
		keyWord = StringFetch.getString("SH_XIAOQU_SEARCH_KEYWORD"); 
		...
		sug = StringFetch.getString("SH_FANGJIA_SUG_KEYWORD");
		keyWord = StringFetch.getString("SH_FANGJIA_SEARCH_KEYWORD"); 
		...
		keyWord = StringFetch.getString("SH_JINGJIREN_SEARCH_KEYWORD"); 
