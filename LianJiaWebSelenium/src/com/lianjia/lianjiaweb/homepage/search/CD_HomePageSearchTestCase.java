...
public class CD_HomePageSearchTestCase extends AbstractHomePageCategory{
	@Override
	public void testMain() throws Throwable {
		logTestPlan("成都站城市首页搜索功能.");
		
		String cityName = StringFetch.getString("L_CHENGDU");		
		...
		String sug = StringFetch.getString("CD_ERSHOUFANG_SUG_KEYWORD");
		String keyWord = StringFetch.getString("CD_ERSHOUFANG_SEARCH_KEYWORD");		
		...
		sug = StringFetch.getString("CD_XINFANG_SUG_KEYWORD");
		keyWord = StringFetch.getString("CD_XINFANG_SEARCH_KEYWORD"); 
		...
		sug = StringFetch.getString("CD_ZUFANG_SUG_KEYWORD");
		keyWord = StringFetch.getString("CD_ZUFANG_SEARCH_KEYWORD");
		...
		sug = StringFetch.getString("CD_XIAOQU_SUG_KEYWORD");
		keyWord = StringFetch.getString("CD_XIAOQU_SEARCH_KEYWORD");		
		...
		sug = StringFetch.getString("CD_FANGJIA_SUG_KEYWORD");
		keyWord = StringFetch.getString("CD_FANGJIA_SEARCH_KEYWORD");
