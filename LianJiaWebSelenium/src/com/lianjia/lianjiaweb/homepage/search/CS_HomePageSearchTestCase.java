...
public class CS_HomePageSearchTestCase extends AbstractHomePageCategory{
	@Override
	public void testMain() throws Throwable {
		logTestPlan("长沙站城市首页搜索功能.");
		...
		String sug = StringFetch.getString("CS_ERSHOUFANG_SUG_KEYWORD");
		String keyWord = StringFetch.getString("CS_ERSHOUFANG_SEARCH_KEYWORD");		
		...
		sug = StringFetch.getString("CS_XINFANG_SUG_KEYWORD");
		keyWord = StringFetch.getString("CS_XINFANG_SEARCH_KEYWORD"); 
		...
		sug = StringFetch.getString("CS_ZUFANG_SUG_KEYWORD");
		keyWord = StringFetch.getString("CS_ZUFANG_SEARCH_KEYWORD");
		...
		sug = StringFetch.getString("CS_XIAOQU_SUG_KEYWORD");
		keyWord = StringFetch.getString("CS_XIAOQU_SEARCH_KEYWORD");		
		...
		sug = StringFetch.getString("CS_FANGJIA_SUG_KEYWORD");
		keyWord = StringFetch.getString("CS_FANGJIA_SEARCH_KEYWORD");
