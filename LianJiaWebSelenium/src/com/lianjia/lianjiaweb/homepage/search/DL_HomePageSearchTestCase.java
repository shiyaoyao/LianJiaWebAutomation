...
public class DL_HomePageSearchTestCase extends AbstractHomePageCategory{
	@Override
	public void testMain() throws Throwable {
		logTestPlan("大连站城市首页搜索功能.");
		...
		String sug = StringFetch.getString("DL_ERSHOUFANG_SUG_KEYWORD");
		String keyWord = StringFetch.getString("DL_ERSHOUFANG_SEARCH_KEYWORD");		
		...
		sug = StringFetch.getString("DL_XINFANG_SUG_KEYWORD");
		keyWord = StringFetch.getString("DL_XINFANG_SEARCH_KEYWORD"); 
		...
		sug = StringFetch.getString("DL_ZUFANG_SUG_KEYWORD");
		keyWord = StringFetch.getString("DL_ZUFANG_SEARCH_KEYWORD");
		...
		sug = StringFetch.getString("DL_XIAOQU_SUG_KEYWORD");
		keyWord = StringFetch.getString("DL_XIAOQU_SEARCH_KEYWORD");		
		...
		sug = StringFetch.getString("DL_FANGJIA_SUG_KEYWORD");
		keyWord = StringFetch.getString("DL_FANGJIA_SEARCH_KEYWORD");
