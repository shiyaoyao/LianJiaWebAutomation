...
public class HZ_HomePageSearchTestCase extends AbstractHomePageCategory{
	@Override
	public void testMain() throws Throwable {
		logTestPlan("杭州站城市首页搜索功能.");
		...
		String sug = StringFetch.getString("HZ_ERSHOUFANG_SUG_KEYWORD");
		String keyWord = StringFetch.getString("HZ_ERSHOUFANG_SEARCH_KEYWORD");		
		...
		sug = StringFetch.getString("HZ_XINFANG_SUG_KEYWORD");
		keyWord = StringFetch.getString("HZ_XINFANG_SEARCH_KEYWORD"); 
		...
		*/
		...
		sug = StringFetch.getString("HZ_ZUFANG_SUG_KEYWORD");
		keyWord = StringFetch.getString("HZ_ZUFANG_SEARCH_KEYWORD");
		...
		sug = StringFetch.getString("HZ_XIAOQU_SUG_KEYWORD");
		keyWord = StringFetch.getString("HZ_XIAOQU_SEARCH_KEYWORD");		
		...
		sug = StringFetch.getString("HZ_FANGJIA_SUG_KEYWORD");
		keyWord = StringFetch.getString("HZ_FANGJIA_SEARCH_KEYWORD");
