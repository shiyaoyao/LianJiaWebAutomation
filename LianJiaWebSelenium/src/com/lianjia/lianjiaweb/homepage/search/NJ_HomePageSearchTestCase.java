...
public class NJ_HomePageSearchTestCase extends AbstractHomePageCategory{
	@Override
	public void testMain() throws Throwable {
		logTestPlan("南京站城市首页搜索功能.");
		...
		String sug = StringFetch.getString("NJ_ERSHOUFANG_SUG_KEYWORD");
		String keyWord = StringFetch.getString("NJ_ERSHOUFANG_SEARCH_KEYWORD");		
		...
		sug = StringFetch.getString("NJ_XINFANG_SUG_KEYWORD");
		keyWord = StringFetch.getString("NJ_XINFANG_SEARCH_KEYWORD"); 
		...
		sug = StringFetch.getString("NJ_ZUFANG_SUG_KEYWORD");
		keyWord = StringFetch.getString("NJ_ZUFANG_SEARCH_KEYWORD");
		...
		sug = StringFetch.getString("NJ_XIAOQU_SUG_KEYWORD");
		keyWord = StringFetch.getString("NJ_XIAOQU_SEARCH_KEYWORD");		
		...
		sug = StringFetch.getString("NJ_FANGJIA_SUG_KEYWORD");
		keyWord = StringFetch.getString("NJ_FANGJIA_SEARCH_KEYWORD");
