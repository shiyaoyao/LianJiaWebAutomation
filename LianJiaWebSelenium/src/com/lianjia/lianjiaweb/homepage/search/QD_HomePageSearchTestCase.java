...
public class QD_HomePageSearchTestCase extends AbstractHomePageCategory{
	@Override
	public void testMain() throws Throwable {
		logTestPlan("青岛站城市首页搜索功能.");
		...
		String sug = StringFetch.getString("QD_ERSHOUFANG_SUG_KEYWORD");
		String keyWord = StringFetch.getString("QD_ERSHOUFANG_SEARCH_KEYWORD");		
		...
		sug = StringFetch.getString("QD_XINFANG_SUG_KEYWORD");
		keyWord = StringFetch.getString("QD_XINFANG_SEARCH_KEYWORD"); 
		...
		sug = StringFetch.getString("QD_ZUFANG_SUG_KEYWORD");
		keyWord = StringFetch.getString("QD_ZUFANG_SEARCH_KEYWORD");
		...
		sug = StringFetch.getString("QD_XIAOQU_SUG_KEYWORD");
		keyWord = StringFetch.getString("QD_XIAOQU_SEARCH_KEYWORD");		
		...
		sug = StringFetch.getString("QD_FANGJIA_SUG_KEYWORD");
		keyWord = StringFetch.getString("QD_FANGJIA_SEARCH_KEYWORD");
