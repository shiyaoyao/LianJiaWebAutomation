...
public class SU_HomePageSearchTestCase extends AbstractHomePageCategory{
	@Override
	public void testMain() throws Throwable {
		logTestPlan("苏州站城市首页搜索功能.");
		...
		String sug = StringFetch.getString("SU_ERSHOUFANG_SUG_KEYWORD");
		String keyWord = StringFetch.getString("SU_ERSHOUFANG_SEARCH_KEYWORD");		
		...
		sug = StringFetch.getString("SU_XINFANG_SUG_KEYWORD");
		keyWord = StringFetch.getString("SU_XINFANG_SEARCH_KEYWORD"); 
		...
		*/
		...
		sug = StringFetch.getString("SU_ZUFANG_SUG_KEYWORD");
		keyWord = StringFetch.getString("SU_ZUFANG_SEARCH_KEYWORD");
		...
		sug = StringFetch.getString("SU_XIAOQU_SUG_KEYWORD");
		keyWord = StringFetch.getString("SU_XIAOQU_SEARCH_KEYWORD");		
		...
		sug = StringFetch.getString("SU_FANGJIA_SUG_KEYWORD");
		keyWord = StringFetch.getString("SU_FANGJIA_SEARCH_KEYWORD");
