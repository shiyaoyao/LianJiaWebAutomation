...
public class SZ_HomePageSearchTestCase extends AbstractHomePageCategory{
	@Override
	public void testMain() throws Throwable {
		logTestPlan("深圳站城市首页搜索功能.");
		
		String cityName = StringFetch.getString("L_SHENZHEN");		
		...
		String sug = StringFetch.getString("SZ_ERSHOUFANG_SUG_KEYWORD");
		String keyWord = StringFetch.getString("SZ_ERSHOUFANG_SEARCH_KEYWORD");		
		...
		sug = StringFetch.getString("SZ_XINFANG_SUG_KEYWORD");
		keyWord = StringFetch.getString("SZ_XINFANG_SEARCH_KEYWORD"); 
		...
		sug = StringFetch.getString("SZ_ZUFANG_SUG_KEYWORD");
		keyWord = StringFetch.getString("SZ_ZUFANG_SEARCH_KEYWORD");
		...
		sug = StringFetch.getString("SZ_XIAOQU_SUG_KEYWORD");
		keyWord = StringFetch.getString("SZ_XIAOQU_SEARCH_KEYWORD");		
		...
		sug = StringFetch.getString("SZ_FANGJIA_SUG_KEYWORD");
		keyWord = StringFetch.getString("SZ_FANGJIA_SEARCH_KEYWORD");
