...
public class TJ_HomePageSearchTestCase extends AbstractHomePageCategory{
	@Override
	public void testMain() throws Throwable {
		logTestPlan("天津站城市首页搜索功能.");
		...
		sug = StringFetch.getString("TJ_ZUFANG_SUG_KEYWORD");
		keyWord = StringFetch.getString("TJ_ZUFANG_SEARCH_KEYWORD");
