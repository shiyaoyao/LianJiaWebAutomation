...
public class WH_HomePageSearchTestCase extends AbstractHomePageCategory{
	@Override
	public void testMain() throws Throwable {
		logTestPlan("武汉站城市首页搜索功能.");
		...
		String sug = StringFetch.getString("WH_ERSHOUFANG_SUG_KEYWORD");
		String keyWord = StringFetch.getString("WH_ERSHOUFANG_SEARCH_KEYWORD");		
		...
		sug = StringFetch.getString("WH_XINFANG_SUG_KEYWORD");
		keyWord = StringFetch.getString("WH_XINFANG_SEARCH_KEYWORD"); 
		...
		sug = StringFetch.getString("WH_ZUFANG_SUG_KEYWORD");
		keyWord = StringFetch.getString("WH_ZUFANG_SEARCH_KEYWORD");
		...
		sug = StringFetch.getString("WH_XIAOQU_SUG_KEYWORD");
		keyWord = StringFetch.getString("WH_XIAOQU_SEARCH_KEYWORD");		
		...
		sug = StringFetch.getString("WH_FANGJIA_SUG_KEYWORD");
		keyWord = StringFetch.getString("WH_FANGJIA_SEARCH_KEYWORD");
